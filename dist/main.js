...
`].filter(nl).join(`
`)),o=$f(o),o=cg(o,t),o=hg(o,t),a=$f(a),a=cg(a,t),a=hg(a,t),o=ug(o),a=ug(a),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`;ha(.5,"FORGING GEOMETRY");var Sp=zu?56:84,KT=new nr(2,2,2,Sp,Sp,Sp),kt={uTime:{value:0},uMorph:{value:0},uAmp:{value:.055},uNScale:{value:1},uNSpeed:{value:.14},uBreathe:{value:1},uTension:{value:0},uMouseStr:{value:0},uMouseDir:{value:new z(0,0,1)},uPortal:{value:0},uPortalAxis:{value:new z(0,0,1)},uRipples:{value:Array.from({length:ua},()=>new Tt(0,0,1,-1))},uRippleMeta:{value:Array.from({length:ua},()=>new Tt(0,1,0,0))},uSweep:{value:0},uSweepOn:{value:0},uDispMix:{value:0},uDispOn:{value:0},uBallDir:{value:new z(0,1,0)},uBallStr:{value:0}},ku=new Rs({color:4868688,metalness:1,roughness:.09,envMapIntensity:1.35});ku.onBeforeCompile=r=>{Object.assign(r.uniforms,kt),r.vertexShader=ZT+JT+r.vertexShader,r.vertexShader=r.vertexShader.replace("#include <beginnormal_vertex>",`
      vec3 liqPos, liqN;
      liquidTransform(position, liqPos, liqN);
      vec3 objectNormal = liqN;
    `).replace("#include <begin_vertex>",`
      vec3 transformed = liqPos;
    `)};ku.customProgramCacheKey=()=>"liquid-chrome";var yt=new Ut(KT,ku);yt.scale.setScalar(1.35);bn.add(yt);function jT(){let r=document.createElement("canvas");r.width=256,r.height=16;let e=r.getContext("2d"),t=e.createLinearGradient(0,0,256,0);t.addColorStop(0,"rgba(255,255,255,0)"),t.addColorStop(.2,"rgba(255,255,255,0.9)"),t.addColorStop(.8,"rgba(255,255,255,0.9)"),t.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=t,e.fillRect(0,0,256,16);let i=new Ia(r);return i.colorSpace=Vi,i}var QT=jT(),Dp=new An,z_=[],$T=[{w:7,x:-3.4,y:2.6,z:-6.5,r:-.16,o:.3},{w:5.5,x:3.8,y:-1.2,z:-8,r:.1,o:.22},{w:9,x:.5,y:-4.2,z:-10,r:-.05,o:.16},{w:4,x:-4.6,y:-6.5,z:-7,r:.22,o:.25},{w:6.5,x:4.2,y:-9.8,z:-9,r:-.12,o:.2},{w:5,x:-3,y:-13.5,z:-6.8,r:.14,o:.26}];$T.forEach(r=>{let e=new Rn({map:QT,color:$s(1,.7),transparent:!0,opacity:r.o,blending:jr,depthWrite:!1}),t=new Ut(new Hn(r.w,.028),e);t.position.set(r.x,r.y,r.z),t.rotation.z=r.r,t.userData.baseY=r.y,t.userData.baseOpacity=r.o,t.userData.depth=-r.z,Dp.add(t),z_.push(e)});bn.add(Dp);var Lp=new An;[[-5,-2,-14,10],[6,-8,-16,12],[0,-18,-13,9]].forEach(([r,e,t,i])=>{let n=new Ut(new Hn(i,i*.62),new Rs({color:657933,roughness:.85,metalness:.4}));n.position.set(r,e,t),Lp.add(n)});bn.add(Lp);var E_=zu?220:420,k_=new vi;{let r=new Float32Array(E_*3);for(let e=0;e<E_;e++)r[e*3]=(Math.random()-.5)*18,r[e*3+1]=(Math.random()-.5)*30-6,r[e*3+2]=-2-Math.random()*10;k_.setAttribute("position",new Hi(r,3))}var V_=new Co({color:2731,size:.035,sizeAttenuation:!0,transparent:!0,opacity:.32,blending:jr,depthWrite:!1}),Cp=new Ra(k_,V_);bn.add(Cp);var fa=new An;fa.visible=!1;var Mp=zu?12:18,ew=new nr(2,2,2,Mp,Mp,Mp),tw=[{baseRadius:1.9,speed:.55,phase:0,size:.3},{baseRadius:1.5,speed:-.42,phase:2.1,size:.24},{baseRadius:2.3,speed:.34,phase:4.4,size:.2}];tw.forEach(r=>{let e=new Ut(ew,ku);e.userData={...r},fa.add(e)});bn.add(fa);var da=new An;da.visible=!1;var iw=[{w:1.7,h:2.1,x:-1.7,y:.5,z:1.3,rotY:.5,rotZ:-.08,opacity:.85},{w:1.5,h:1.9,x:1.8,y:-.5,z:.5,rotY:-.4,rotZ:.1,opacity:.78},{w:1.3,h:1.7,x:.1,y:1.1,z:2.2,rotY:.15,rotZ:.04,opacity:.7}],H_=[];iw.forEach(r=>{let e=new Na({color:16777215,metalness:0,roughness:.05,transmission:1,thickness:.6,ior:1.4,clearcoat:1,clearcoatRoughness:.1,envMapIntensity:2,transparent:!0,opacity:r.opacity,side:Qi}),t=new Hn(r.w,r.h),i=new Ut(t,e);i.position.set(r.x,r.y,r.z),i.rotation.set(0,r.rotY,r.rotZ),i.userData={baseY:r.y,baseRotY:r.rotY,baseRotZ:r.rotZ};let n=new Ao({color:$s(1,.55),transparent:!0,opacity:.6}),s=new Ca(new La(t),n);H_.push(n),i.add(s),da.add(i)});bn.add(da);var pr=new Wh(vs);pr.setPixelRatio(U_);pr.setSize(window.innerWidth,window.innerHeight);pr.addPass(new Xh(bn,Sn));var nw=new Vo(new Oe(window.innerWidth,window.innerHeight),.34,.75,.86);pr.addPass(nw);pr.addPass(new Zh);var rw={uniforms:{tDiffuse:{value:null},uCA:{value:.0026},uVel:{value:0},uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
