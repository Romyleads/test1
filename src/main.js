...
const FX = {
  story: {
    name: 'SCROLL STORY',
    line: 'The default narrative: one chrome body travelling the page, sphere to cube, directed entirely by your scroll.',
    benefit: 'The page itself becomes the timeline.',
    best: 'Full-page product narratives.',
  },
  liquid: {
    name: 'LIQUID MORPHING',
    line: 'The object looks physically alive and can transform between completely different shapes without a hard cut.',
    benefit: 'Organic continuity — no transition ever feels like an edit.',
    best: 'Hero sections, product storytelling, brand transitions.',
  },
  shape: {
    name: 'SHAPE MORPHING',
    line: 'Geometry itself is the narrative: one primitive flows into another while staying a single continuous surface.',
    benefit: 'A clear before/after told in a single object.',
    best: 'Feature reveals, logo moments, state changes.',
  },
  interactive: {
    name: 'INTERACTIVE 3D',
    line: 'The object listens. Every cursor movement gets a slow, physical answer — tilt, inertia, shifting reflections.',
    benefit: 'Presence — the page feels inhabited, not rendered.',
    best: 'Landing pages, portfolio centerpieces, configurators.',
  },
  scrollmorph: {
    name: 'SCROLL-DRIVEN MORPH',
    line: 'The transformation is bound 1:1 to scroll position — scrub the film forward and backward with your thumb.',
    benefit: 'The user directs the animation; nothing plays without consent.',
    best: 'Story pages, product walkthroughs, editorial features.',
  },
  scale: {
    name: '3D SCALE',
    line: 'True perspective scale: the object physically travels toward and away from the lens, not a CSS zoom.',
    benefit: 'Real depth — parallax and focus shift for free.',
    best: 'Dramatic entrances, section transitions, spec highlights.',
  },
  zoom: {
    name: 'INFINITE ZOOM',
    line: 'The camera keeps travelling into the chrome surface and never arrives — space feels endless.',
    benefit: 'Hypnotic depth that makes a single object feel like a world.',
    best: 'Chapter transitions, immersive intros, portal narratives.',
  },
  portal: {
    name: 'PORTAL DEFORMATION',
    line: 'A liquid aperture opens inside the body — the surface folds inward like a door into somewhere else.',
    benefit: 'A transition metaphor the viewer instantly understands.',
    best: 'Page transitions, reveal moments, dimensional storytelling.',
  },
  orbit: {
    name: 'CAMERA ORBIT',
    line: 'The product stands perfectly still while the world revolves around it — pure showroom language.',
    benefit: 'Every angle earns screen time without touching the object.',
    best: 'Product pages, 360° showcases, automotive reveals.',
  },
  parallax: {
    name: 'PARALLAX DEPTH',
    line: 'Foreground, object, light structures and dust all move at different speeds — flat page becomes physical space.',
    benefit: 'Depth perception with almost zero extra content.',
    best: 'Editorial design, atmospheric landing pages, depth cues.',
  },
  mousemorph: {
    name: 'MOUSE-REACTIVE MORPH',
    line: 'Your cursor becomes a fingertip pressing into liquid metal — controlled local deformation, then perfect recovery.',
    benefit: 'Tactility: the interface acquires a sense of touch.',
    best: 'Interactive heroes, playful brand moments, tactile UI.',
  },
};
